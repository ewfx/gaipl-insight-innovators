...
# Run this app with: streamlit run incident_resolver.py
...
def incident_resolver():
    ...
    # st.header("🧠 AI-Powered Incident Management Console")

    # Sidebar – Select Incident
    # incident_id = st.sidebar.selectbox("Select an Incident ID", incidents_df["incident_id"].tolist())
    incident_id = st.selectbox("Select an Incident ID", incidents_df["incident_id"].tolist())
